...
export class MIMEMessage implements MIMEMessageClass {
   ...
   * @throws {EmailErrorInterface} Throws an error if no content is added to the message.
   */
  asRaw(): string {
    const eol = "\r\n";
   ...
   * @throws {EmailErrorInterface} Throws an error if the filename is missing or if the content type is invalid.
   */
   ...
   * @throws {EmailErrorInterface} Throws an error if the content type is invalid.
   */
